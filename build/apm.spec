...
hiddenimports = [
    ...
    *collect_submodules('apm_cli.adapters.client.copilot'),
    ...
    *collect_submodules('apm_cli.compilation.agents_compiler'),
    ...
    *collect_submodules('apm_cli.compilation.context_optimizer'),
    ...
    'apm_cli.core.auth',
    *collect_submodules('apm_cli.core.auth'),
    'apm_cli.core.script_runner',
    *collect_submodules('apm_cli.core.script_runner'),
    'apm_cli.core.command_logger',
    *collect_submodules('apm_cli.core.command_logger'),
    ...
    *collect_submodules('apm_cli.install'),
    ...
    'apm_cli.commands.deps.sections',
    'apm_cli.commands.deps.sections.scope_resolver',
    'apm_cli.commands.deps.sections.update_engine',
    'apm_cli.deps',
    'apm_cli.deps.aggregator',
    'apm_cli.deps.verifier',
    'apm_cli.deps.apm_resolver',
    *collect_submodules('apm_cli.deps.download_strategies'),
    ...
    *collect_submodules('apm_cli.models.validation'),
    'apm_cli.output',
    ...
    *collect_submodules('apm_cli.integration.command_integrator'),
    *collect_submodules('apm_cli.integration.skill_integrator'),
    *collect_submodules('apm_cli.integration.mcp_integrator'),
    *collect_submodules('apm_cli.integration.hook_integrator'),
    *collect_submodules('apm_cli.integration.mcp_integrator_install'),
    *collect_submodules('apm_cli.policy.discovery'),
    *collect_submodules('apm_cli.policy.policy_checks'),
    *collect_submodules('apm_cli.marketplace.yml_schema'),
    *collect_submodules('apm_cli.marketplace.builder'),
    *collect_submodules('apm_cli.bundle.plugin_exporter'),
    *collect_submodules('apm_cli.commands.audit_content'),
    *collect_submodules('apm_cli.commands.deps.sections'),
    *collect_submodules('apm_cli.commands.install.manifest_ops'),
    *collect_submodules('apm_cli.deps.bare_cache'),
    *collect_submodules('apm_cli.deps.plugin_parser'),
    'apm_cli.utils',
